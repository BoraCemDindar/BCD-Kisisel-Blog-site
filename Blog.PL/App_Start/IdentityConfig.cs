...
namespace Blog.PL
{
    ...
    {
        public ApplicationUserManager(IUserStore<AdminUser> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AdminUser>(context.Get<BlogContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<AdminUser, string>
    {
